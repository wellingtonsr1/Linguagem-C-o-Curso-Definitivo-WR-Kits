...
int main(int argc, char *argv[])
{
    ...
    putchar('\n');
<<<<<<< HEAD:M08-Avan̤ado_Parte_1/Aula_3-Ponteiros_para_Fun̵̤es/exercicio-2.c
=======
    
>>>>>>> 099852941e2bcf04d93fed0209fd2af4ba64fc33:M08-Avan̤ado_Parte_1/Aula_3-Ponteiros_para_Fun̵̤es/exrcicio-2.c
    printf("----------------------------------------------\n");  
