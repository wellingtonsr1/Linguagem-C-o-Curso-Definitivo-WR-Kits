...
//função para mostrar os caracteres e o tempo de visualização
int painel( char tela[14])
{
   ...
   if((contador==7)&&(cont > 0))
   {
         ...
         if((resp == 's')||(resp == 'S')) 
         {
            encerrar();//após a escolha do  jogador esta função é chamada para fechar o programa
         }  
   }
...
//função para mostrar os numeros na tela
...
}//fim da função encerrar

//grava o nome e a pontuação do jogador no arquivo
...
//lê a pontuação que foi salva no arquivo
...
//exclui a pontuação que foi salva no arquivo
